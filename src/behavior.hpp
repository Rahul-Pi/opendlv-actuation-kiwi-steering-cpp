...
class Behavior {
 ...
 public:
  ...
  void setAimAngle(opendlv::proxy::AngleReading const &) noexcept;
  void setKiwiDetect(opendlv::logic::perception::KiwiDetection const &) noexcept;
  void setIntersectionDetect(opendlv::proxy::SwitchStateRequest const &) noexcept;
  void step() noexcept;
 ...
 private:
  ...
  opendlv::proxy::AngleReading m_aimAngleReading;
  opendlv::logic::perception::KiwiDetection m_kiwiDetect;
  opendlv::proxy::SwitchStateRequest m_intersectionDetect;
  ...
  std::mutex m_aimAngleReadingMutex;
  std::mutex m_kiwiDetectMutex;
  std::mutex m_intersectionDetectMutex;
};
